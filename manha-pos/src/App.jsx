...
// KEEP THIS ID THE SAME TO PREVENT DATA LOSS
...
export default function App() {
  ...
  const handleBackupData = () => {
    ...
    a.href = url;
    a.download = `hossain_traders_backup_${new Date().toISOString().slice(0,10)}.json`;
                ...
                <div className="p-8 md:p-12 overflow-y-auto flex-1" id="receipt-area">
                  <div className="border-b-2 border-gray-800 pb-8 mb-8">
                    ...
                    <div className="text-center mb-6">
                      ...
                      <p className="text-xs font-semibold text-gray-700 mt-1">Proprietor: Md Amir Hossain, Mobile: 01766287043</p>
                    </div>
      ...
      <style>{`
        @media print {
          ...
          #receipt-area {
            ...
            /* FIX: Remove absolute positioning to prevent blank pages */
